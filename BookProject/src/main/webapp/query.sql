create table member(userid varchar2(10), userpwd varchar2(10));
...
create table bookshop(isbn varchar2(15) primary key not null, title varchar2(50) not null, author varchar2(20) not null, company varchar2(50), price number);
